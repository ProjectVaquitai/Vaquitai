...
logo = Image.open(r'/root/MtBuller/src/assets/favicon.png')
profile = Image.open(r'/root/MtBuller/src/assets/favicon.png')
if choose == "About":
    ...
    st.image(profile, width=700 )
        ...
        if topic=='Pandas':
            feature_image1 = Image.open(r'/root/MtBuller/src/assets/favicon.png')
            with st.container():
            ...
            st.write('---')
            feature_image2 = Image.open(r'/root/MtBuller/src/assets/favicon.png')
            with st.container():
                image_col, text_col = st.columns((1,3))
                with image_col:
            ...
            st.write('---')
            feature_image3 = Image.open(r'/root/MtBuller/src/assets/favicon.png')
            with st.container():
                image_col, text_col = st.columns((1,3))
                with image_col:
